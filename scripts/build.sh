...
(cd "$BUILD" && find "integrate-wpforms-mattermost" -type f -print | LC_ALL=C sort | zip -X -q "integrate-wpforms-mattermost-1.0.0.zip" -@)

echo "$BUILD/integrate-wpforms-mattermost-1.0.0.zip"
